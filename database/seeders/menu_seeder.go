...
func (s *MenuSeeder) Run() error {
	menus := []models.Menu{
		...
		},
		{
			...
			Name:       "crud",
			Path:       "/system/crud",
			Component:  "@/pages/system/crud/index.vue",
			Icon:       "ApiOutlined",
			MenuType:   "page",
			Cacheable:  true,
			RenderMenu: true,
			Permission: "system:crud:index",
			Sort:       0,
			Target:     "_self",
			Badge:      "",
		},
		{
			...
			Title:      "字段设计",
			Name:       "column",
			Path:       "/system/crud/:id/column",
			Component:  "@/pages/system/crud/column.vue",
			Icon:       "FormatPainterOutlined",
			MenuType:   "page",
			Cacheable:  true,
			RenderMenu: false,
			Permission: "system:crud:column",
			Sort:       0,
			Target:     "_self",
			Badge:      "",
		},
